...
export default function (Z) {
  ...
  function Q(d, c, e, h) {
    ...
    switch (m) {
      ...
      case 975:
        c = (a = d).length - 10
        b = (33 === charCodeAt(a, c) ? a.substring(0, c) : a)
      ...
      case 953:
        if (!0 === oa.test(d))
          return 115 === (b = d.substring(indexOf(d, ':') + 1)).charCodeAt(0)
      ...
      case 962:
        if (
          ...
          return (
            a
              .substring(0, indexOf(a, ';', 27) + 1)
              .replace(pa, '$1' + WEBKIT + '$2') + a
          )
    }
    return a
  }
